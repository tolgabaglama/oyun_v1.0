...
export function sekmeDosya(s: DosyaSekmesiSecenekleri): HTMLElement {
  ...
  return el("div", { sinif: "sekme-icerik dosya-sekmesi" },
    ...
    el("section", { sinif: "bolum" },
      el("h2", {}, `DOSYA ${String(dosya.seed).padStart(4, "0")} / ${dosya.zorluk_adi.toUpperCase()}`),
      dosya.nitelikli_hedef && el("div", { sinif: "nitelikli-rozet" },
        el("strong", {}, "NİTELİKLİ HEDEF"),
        el("span", {}, "Bu kişi az iz bırakmış. Çözüm normalden pahalıya mal olacak."),
      ),
      el("div", { sinif: "seed-satiri" },
        el("span", {}, "Dosya numarası: ", el("strong", {}, String(dosya.seed))),
      ...
      el("div", { sinif: "ihbar-kutu" },
        el("div", { sinif: "ihbar-baslik" }, "BİLGİ NOTU"),
        el("p", { sinif: "ihbar-metin" }, dosya.ihbar_notu || "Not girilmemiş."),
      ),
      el("p", { sinif: "ipucu" }, "Bu nottaki bilgi eksik olabilir, bazen yanlıştır."),
    ),
